...
<iframe src="YIGBYMap (1).png" height="855" width="95%"></iframe>
...
*This map includes statewise legislation. YIGBY laws have also been passed at the local level, which is not included in the visualization.
